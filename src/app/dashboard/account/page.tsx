...
export default async function DashboardAccountPage() {
  ...
  return (
    <div className="max-w-lg">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">1:1 Sessions</h2>
        <div className="rounded-xl border border-bgDark-2/20 bg-white p-6 space-y-4">
          <p className="text-gray-700">
            Private coaching sessions are coming soon. For now, contact us directly
            and we&apos;ll coordinate availability.
          </p>
          <Link
            href="/contact"
