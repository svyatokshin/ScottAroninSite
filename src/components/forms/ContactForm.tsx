        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={4}
              className="w-full px-4 py-3 border border-zen-purple/40 rounded-lg focus:ring-2 focus:ring-zen-blue-light/60 focus:border-zen-blue-light/60 transition-all duration-300 bg-[#0A1428]/50 backdrop-blur-sm text-white placeholder-white/60 resize-none"
