        ...
        {data.heroSection.heroImage && (
          ...
          >
            ...
            />
             ...
             <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#050A14] via-[#050A14]/90 to-transparent" />
             <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-[#0F1B2D] via-[#0F1B2D]/80 to-transparent" />
             <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-[#1E0B3B] via-[#1E0B3B]/60 to-transparent" />
          </motion.div>
        )}
          ...
          >
           ...
           <div className="container mx-auto px-4 relative z-10">
             <div className="max-w-7xl mx-auto">
               <div className="relative bg-[#0A1428]/90 backdrop-blur-sm rounded-[2rem] p-12 md:p-16 shadow-2xl overflow-hidden border border-zen-purple/30">
                 {/* Premium card background matching space theme */}
                 <div className="absolute inset-0 bg-gradient-to-br from-[#0A1428] via-[#0F1B2D]/95 to-[#1E0B3B]/90" />
                 ...
                 <div className="relative z-10 flex flex-col lg:flex-row items-start gap-16 lg:gap-20">
                   ...
                   <div className="flex-1 space-y-8">
                       ...
                       {data.aboutSection?.content && typeof data.aboutSection.content === 'string' && (() => {
                         ...
                         return (
                           <div className="prose prose-xl max-w-none">
                             <div className="text-lg md:text-xl leading-relaxed text-white/90 font-light">
                     ...
                     <div className="pt-6">
                       <Link href="/contact" className="inline-flex items-center gap-4 text-zen-blue-light/80 hover:text-white transition-colors duration-300 group cursor-pointer">
         ...
         <div className="container mx-auto px-4 relative z-10">
           {data.cardSectionsTitle && (
             <div className="text-center mb-20">
               <div className="inline-flex items-center gap-3 text-zen-blue-light/80 text-sm font-medium tracking-widest uppercase mb-4">
               ...
               <h2 className="text-5xl md:text-6xl lg:text-7xl font-playfair font-light text-white leading-tight tracking-tight mb-6">
                 {data.cardSectionsTitle}
               </h2>
           ...
           {data.mainSectionOne && (
             ...
             >
               <div className="flex-1 space-y-6">
                 ...
                 <div className="prose prose-xl max-w-none">
                   <p className="text-xl leading-relaxed text-white/85 font-light">{data.mainSectionOne.content}</p>
                 </div>
               </div>
               <div className="flex-shrink-0 w-full lg:w-1/2">
                 <div className="relative group">
                   ...
                   {data.mainSectionTwo && (
             <motion.section
               className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-20"
               initial={{ opacity: 0, y: 40 }}
               whileInView={{ opacity: 1, y: 0 }}
               transition={{ duration: 0.8 }}
               viewport={{ once: true }}
       ...
       <section className="py-32 bg-gradient-to-br from-[#050A14] via-[#0F1B2D] to-[#1E0B3B] relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 relative z-10">
           ...
           >
             ...
             <h2 className="text-5xl md:text-6xl font-playfair font-light text-white leading-tight tracking-tight mb-8">
               Stay Connected
             </h2>
             ...
             <form className="flex flex-col md:flex-row gap-6 justify-center items-center">
               <input
                 ...
                 className="px-8 py-4 rounded-full border border-zen-purple/40 bg-[#0A1428]/50 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-zen-blue-light/60 focus:border-zen-blue-light/60 font-light backdrop-blur-sm min-w-[300px]"
               />
               <button
                 type="submit"
                 className="bg-gradient-to-r from-zen-blue-light to-zen-purple-light text-[#050A14] px-10 py-4 rounded-full hover:from-zen-blue to-zen-purple transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:scale-105"
               >
                 Subscribe
               </button>
             </form>
        ...
        return (
          ...
          >
             ...
             >
               ...
               <button
                 onClick={handleCloseModal}
                 className="absolute top-6 right-6 text-zen-blue-light/60 hover:text-white text-3xl font-bold focus:outline-none transition-colors z-10"
