...
export function HomePageClient({ data }: HomePageClientProps) {
  ...
  useEffect(() => {
    ...
    // Add debugging for Main Section Three
    console.log('Main Section Three details:', {
      title: data.mainSectionThree?.title,
      content: data.mainSectionThree?.content,
      mediaType: data.mainSectionThree?.mediaType,
      image: data.mainSectionThree?.image,
      video: data.mainSectionThree?.video
    });
    ...
    // Add debugging for Main Section Three media
    console.log('Main Section Three media:', {
      mediaType: data.mainSectionThree?.mediaType,
      image: data.mainSectionThree?.image,
      video: data.mainSectionThree?.video,
      imageUrl: data.mainSectionThree?.image ? urlFor(data.mainSectionThree.image).url() : null
    });
  }, [data]);
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-10 md:gap-16 text-center md:text-left">
                {data.cardSectionOne.image && (
                  <div className="flex-shrink-0 transform group-hover:scale-105 transition-transform duration-500">
                    <Image
                      src={urlFor(data.cardSectionOne.image).url()}
                      alt={data.cardSectionOne.title}
                      width={240}
                      height={240}
                ...
                <div className="flex-1">
                  ...
                  <div className="prose prose-lg prose-invert max-w-none text-white/90">
                    <PortableText value={data.cardSectionOne.content} />
                  </div>
                  <div className="mt-8">
                    <Link
                      href="#"
        ...
        {data.mainSectionThree && (
          ...
          >
            <div className="flex-1">
              ...
              <div className="prose prose-lg max-w-none text-zen-blue-dark">
                <PortableText value={data.mainSectionThree.content} />
              </div>
            </div>
            <div className="flex-shrink-0 w-full md:w-1/2 rounded-2xl overflow-hidden shadow-xl bg-zinc-100">
              {data.mainSectionThree.mediaType === 'video' && data.mainSectionThree.video?.url ? (
                ...
                <div className="relative aspect-video">
                  <Image
                    src={urlFor(data.mainSectionThree.image).url()}
                    alt={data.mainSectionThree.title || 'Main Section Three'}
                    fill
                    className="object-cover"
                    priority={false}
                  />
